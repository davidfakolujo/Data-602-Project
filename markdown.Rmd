...
**Checking Hypergeometric function with fixed sample size n = 4**
```{r}
...
**Checking Hypergeometric function with fixed sample size n = 5**
```{r}
...
**Checking Hypergeometric function with fixed sample size n = 6**
```{r}
