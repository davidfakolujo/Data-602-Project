...
Testing for different values of $\theta_0$ $\newline$
$\theta_0 = 150$

```{r}
nn2 = rnhyper(1000, 496-150, 150, 1)
nn2
```
...
for (i in 1:1000) {
  possible_theta = 1:495
  probability = dnhyper(nn2[i], 496 - possible_theta, possible_theta, 1)
  MLE_Y[i] = possible_theta[which.max(probability)]
}
MLE_Y
```
...
rmse2
```
Checking for $\theta_0 = 450$
```{r}
nn3 = rnhyper(1000, 496-450, 450, 1)
nn3
```
...
for (i in 1:1000) {
  possible_theta = 1:495
  probability = dnhyper(nn3[i], 496 - possible_theta, possible_theta, 1)
  MLE_Y[i] = possible_theta[which.max(probability)]
}
MLE_Y
```
...
**Checking Hypergeometric distribution with fixed sample size n = 4**
```{r}
X = rhyper(1000, 331, 496-331, 4)
X
```
...
for (i in 1:1000) {
  possible_theta = 0:496
  probability = dhyper(X[i], possible_theta, 496-possible_theta, 4)
  MLE_X[i] = possible_theta[which.max(probability)]
}
MLE_X
```
...
**Checking Hypergeometric distribution with fixed sample size n = 5**
```{r}
X = rhyper(1000, 331, 496-331, 5)
X
```
...
for (i in 1:1000) {
  possible_theta = 0:496
  probability = dhyper(X[i], possible_theta, 496-possible_theta, 5)
  MLE_X[i] = possible_theta[which.max(probability)]
}
MLE_X
```
...
**Checking Hypergeometric distribution with fixed sample size n = 6**
```{r}
X = rhyper(1000, 331, 496-331, 6)
X
```
...
for (i in 1:1000) {
  possible_theta = 0:496
  probability = dhyper(X[i], possible_theta, 496-possible_theta, 6)
  MLE_X[i] = possible_theta[which.max(probability)]
}
MLE_X
```
